                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="fournisseur" name="fournisseur">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select form-control" id="fournisseur" name="option">
                                                <option value="Tous">Tous</option>
                                    ...
                                    <div class="col-sm-2 ">
                                        <button class="btn btn-lg btn-primary" type="submit" style="margin-top: 2em">Afficher</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="">
                                            <div class="form-group" style="font-size: 14px">
                                                @if((Auth::user()->roles()->where('libelle', ['CONTROLEUR'])->exists() || Auth::user()->roles()->where('libelle', ['VALIDATEUR'])->exists() || Auth::user()->roles()->where('libelle', ['SUPERVISEUR'])->exists()))
                                                <input type="date" disabled class="form-control col-md-12" value="{{$programmation->dateSortie ?  : ''}}">
                                                @else
                                        ...
                                        <td class="">
                                            <div class="form-group" style="font-size: 14px">
                                                ...
                                                <form action="/programmation/livraison/bl/{{ $programmation->id }}/{{Auth::user()->name }}')" method="post">
                                                    @csrf
                                                    <!-- AUSSI LONGTEMPS QUE LE BL N'EST PAS VALIDER, ON A TOUJOURS LA POSSIBILITE DE LE MODIFIER -->
                                                    <input type="text" class="form-control col-md-12" name="bl" value="{{$programmation->bl_gest ?  : ''}}" @if($programmation->detailboncommande->boncommande->statut == "Livrer") readonly @endif>
                                                    <span class="text-danger text-center d-block"> {{$programmation->detailboncommande->boncommande->statut}} </span>
                                                </form>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="">
                                            <div class="form-group" style="font-size: 14px">
                                                @if(!(Auth::user()->roles()->where('libelle', ['CONTROLEUR'])->exists() || Auth::user()->roles()->where('libelle', ['VALIDATEUR'])->exists() || Auth::user()->roles()->where('libelle', ['SUPERVISEUR'])->exists()))
                                                <input type="text" placeholder="Pas encore" disabled class="form-control col-md-12">
                                                @else
                                                <input type="date" class="form-control col-md-12" onchange="handleDateChange('{{ $programmation->id }}', this)" value="{{$programmation->dateSortie ?  : ''}}" @if ($programmation->dateSortie) readonly @endif>
                                                @endif
                                                <div class="message-container d-none"></div> <!-- Conteneur pour le message -->
