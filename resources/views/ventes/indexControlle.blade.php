                        ...
                        <div class="card-header">
                            ...
                            <form method="GET">
                                <div class="row">
                                    <div class="col-1"></div>
                                    <div class="col-4">
                                        <input hidden class="form-control" name="filtre">
                                        <div class="form-group">
                                            <label for="">Date début</label>
                                            <input type="date" required class="form-control" name="debut" value="{{old('debut')}}" required>
                                        </div>
                                        @error('debut')
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" required class="form-control" name="fin" value="{{old('fin')}}" required>
                                        </div>
                                        @error('fin')
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
