                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped table-sm" style="font-size: 12px">
                                ...
                                <tbody class="table-body">
                                    @if ($venteUpdateDemands->count() > 0)
                                    @foreach($venteUpdateDemands as $demand)
                                    <tr style="align-items: center;">
                                        <td>{{ $loop->index +1 }}</td>
                                        <td>{{ $demand->_Vente->code }}</td>
                                        ...
                                        <td class="text-center">
                                            <a href="{{$demand->prouve_file}}" target="_blank" rel="noopener noreferrer">
                                                <img src="{{$demand->prouve_file}}" title="Visualiser" alt="" style="width: 100px;border-radius:10px;cursor:pointer">
                                            </a>
                                        </td>
                                        <td>
