                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Listes banques</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                                            ...
                                            @foreach($banques as $banque)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a class="btn btn-danger btn-sm" href="{{ route('banques.delete', ['id'=>$banque->id]) }}"><i class="fa-solid fa-trash-can"></i></a>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-md-right dropdown-menu-icon-list drop text-sm">
                                                                <a class="dropdown-item" href="{{ route('comptes.index', ['banque'=>$banque->id]) }}"><i class="fa-solid fa-money-check-dollar"></i> Compte</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    @endif
