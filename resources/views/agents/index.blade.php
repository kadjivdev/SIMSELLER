                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Nouveau Type Client</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nom" class="form-control form-control-sm @error('nom') is-invalid @enderror" name="nom" style="text-transform: uppercase" value="{{ old('nom') }}" autocomplete="off" autofocus required>
                                                        @error('libelle')
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="prenom" class="form-control form-control-sm @error('prenom') is-invalid @enderror" name="prenom" style="text-transform:none" value="{{ old('prenom') }}" autocomplete="off" autofocus required>
                                                        @error('prenom')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped table-sm" style="font-size: 12px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $compteur++ }}</td>
                                        <td class="ml-5 pr-5">{{ $agent->nom }}</td>
                                        <td class="ml-5 pr-5">{{ $agent->prenom }}</td>
                                        <td class="ml-5 pr-5">{{ $agent->telephone }}</td>
                                        <td class="ml-5 pr-5">{{ $agent->Adresse }}</td>
                                        @if(!(Auth::user()->roles()->where('libelle', ['CONTROLEUR'])->exists() || Auth::user()->roles()->where('libelle', ['VALIDATEUR'])->exists() || Auth::user()->roles()->where('libelle', ['SUPERVISEUR'])->exists()))
                                        <td class="text-center">
                                            <!--<a class="btn btn-success btn-sm" href="#"><i class="fa-regular fa-eye"></i></a>-->
                                            <a class="btn btn-secondary btn-sm" href="{{ route('agent.affecter', ['agent'=> $agent->id] ) }}"><i class="fa-solid fa-eye"></i></a>
                                            <a class="btn btn-warning btn-sm" href="{{ route('agent.edit', ['agent'=> $agent->id])  }}"><i class="fa-solid fa-pen-to-square"></i></a>
                                            <a class="btn btn-danger btn-sm" href="{{ route('agent.delete',['agent'=> $agent->id])  }}"><i class="fa-solid fa-trash-can"></i></a>
                                        </td>
                                        @endif
                                        <!-- <td class="text-center">
                                                    <div class="dropdown">
